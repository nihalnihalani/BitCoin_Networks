...
serverPortF2 = 3000
serverName = 'localhost'
uncomfirmtx = open("/Users/nihalnihalani/Desktop/Github/BitCoin_Networks/pythonProject9/ClientB/Unconfirmed_B.txt", "w")
...
def NewTransaction():
    while True:
        ...
        uncomfirmtx = open("/Users/nihalnihalani/Desktop/Github/BitCoin_Networks/pythonProject9/ClientB/Unconfirmed_B.txt", "a+")
...
def LastXconfirmedTransactions(X):
    with open("/Users/nihalnihalani/Desktop/Github/BitCoin_Networks/pythonProject9/ClientB/Unconfirmed_B.txt") as file:
...
def BlockCreated(done):
    if done=="1":
        f = open('/Users/nihalnihalani/Desktop/Github/BitCoin_Networks/pythonProject9/ClientB/Unconfirmed_B.txt.txt')
        f1 = open('/Users/nihalnihalani/Desktop/Github/BitCoin_Networks/pythonProject9/ClientB/Confirmed_B.txt', 'a')
